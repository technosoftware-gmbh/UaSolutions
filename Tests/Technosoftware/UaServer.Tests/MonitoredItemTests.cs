...
namespace Technosoftware.UaServer.Tests
{
    ...
    public class MonitoredItemTests
    {
        ...
        public void CreateMI()
        {
            ...
            UaMonitoredItem monitoredItem = CreateMonitoredItem(telemetry);
            ...
            monitoredItem.Publish(new UaServerOperationContext(monitoredItem), result, result2, 1, logger);
        ...
        public void CreateEventMI()
        {
            ...
            UaMonitoredItem monitoredItem = CreateMonitoredItem(telemetry, true);
            Assert.That(monitoredItem, Is.Not.Null);
            Assert.That(monitoredItem.ItemsInQueue, Is.EqualTo(0));
        ...
        public void CreateMIQueueNoQueue()
        {
            ...
            UaMonitoredItem monitoredItem = CreateMonitoredItem(telemetry, false, 0);
        ...
        public void CreateEventMIOverflow()
        {
            ...
            UaMonitoredItem monitoredItem = CreateMonitoredItem(telemetry, true, 2);
            Assert.That(monitoredItem, Is.Not.Null);
            Assert.That(monitoredItem.ItemsInQueue, Is.EqualTo(0));
        ...
        public void CreateEventMIOverflowMultiplePublish()
        {
            ...
            var result = new Queue<EventFieldList>();
            bool moreItems = monitoredItem.Publish(new UaServerOperationContext(monitoredItem), result, 2);
        ...
        public void CreateEventMIOverflowNoDiscard()
        {
            ...
            UaMonitoredItem monitoredItem = CreateMonitoredItem(telemetry, true, 2, true);
            Assert.That(monitoredItem, Is.Not.Null);
            Assert.That(monitoredItem.ItemsInQueue, Is.EqualTo(0));
        ...
        public void CreateEventMIPublishPartial()
        {
            ...
            UaMonitoredItem monitoredItem = CreateMonitoredItem(telemetry, true, 3);
            Assert.That(monitoredItem, Is.Not.Null);
            Assert.That(monitoredItem.ItemsInQueue, Is.EqualTo(0));
