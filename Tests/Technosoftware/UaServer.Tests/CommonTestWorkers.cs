...
namespace Technosoftware.UaServer.Tests
{
    ...
    public static class CommonTestWorkers
    {
        ...
        [
            new ExpandedNodeId(
                "Scalar_Static_SByte",
                SampleCompany.NodeManagers.Reference.Namespaces.ReferenceServer),
            new ExpandedNodeId(
                "Scalar_Static_Int16",
                SampleCompany.NodeManagers.Reference.Namespaces.ReferenceServer),
            new ExpandedNodeId(
        ...
        [
            new ExpandedNodeId(
                SampleCompany.NodeManagers.TestData.Variables.Data_Static_Scalar_Int16Value,
                SampleCompany.NodeManagers.TestData.Namespaces.TestData),
            new ExpandedNodeId(
                SampleCompany.NodeManagers.TestData.Variables.Data_Static_Scalar_Int32Value,
                SampleCompany.NodeManagers.TestData.Namespaces.TestData),
            new ExpandedNodeId(
                SampleCompany.NodeManagers.TestData.Variables.Data_Static_Scalar_UInt16Value,
                SampleCompany.NodeManagers.TestData.Namespaces.TestData),
            new ExpandedNodeId(
                SampleCompany.NodeManagers.TestData.Variables.Data_Static_Scalar_UInt32Value,
                SampleCompany.NodeManagers.TestData.Namespaces.TestData)
        ];
        ...
        [
            new ExpandedNodeId(
                SampleCompany.NodeManagers.TestData.Variables.Data_Dynamic_Scalar_Int16Value,
                SampleCompany.NodeManagers.TestData.Namespaces.TestData),
            new ExpandedNodeId(
                SampleCompany.NodeManagers.TestData.Variables.Data_Dynamic_Scalar_Int32Value,
                SampleCompany.NodeManagers.TestData.Namespaces.TestData),
            new ExpandedNodeId(
                SampleCompany.NodeManagers.TestData.Variables.Data_Dynamic_Scalar_UInt16Value,
                SampleCompany.NodeManagers.TestData.Namespaces.TestData),
            new ExpandedNodeId(
                SampleCompany.NodeManagers.TestData.Variables.Data_Dynamic_Scalar_UInt32Value,
                SampleCompany.NodeManagers.TestData.Namespaces.TestData),
            new ExpandedNodeId(
                SampleCompany.NodeManagers.TestData.Variables.AnalogScalarValueObjectType_UInt32Value,
                SampleCompany.NodeManagers.TestData.Namespaces.TestData
            ),
            new ExpandedNodeId(
                SampleCompany.NodeManagers.TestData.Variables.Data_Dynamic_AnalogArray_ByteValue,
                SampleCompany.NodeManagers.TestData.Namespaces.TestData),
            new ExpandedNodeId(
                SampleCompany.NodeManagers.TestData.Variables.Data_Dynamic_Scalar_VectorValue,
                SampleCompany.NodeManagers.TestData.Namespaces.TestData),
            new ExpandedNodeId(
                SampleCompany.NodeManagers.TestData.Variables.Data_Dynamic_Scalar_VectorValue_X,
                SampleCompany.NodeManagers.TestData.Namespaces.TestData),
            new ExpandedNodeId(
                SampleCompany.NodeManagers.TestData.Variables.Data_Dynamic_Structure_ScalarStructure,
                SampleCompany.NodeManagers.TestData.Namespaces.TestData)
        ];
        ...
        [
            (typeof(short), Enumerable.Range(0, 100).Select(i =>
                new ExpandedNodeId($"Scalar_Static_Mass_Int16_Int16_{i:D2}", SampleCompany.NodeManagers.Reference.Namespaces.ReferenceServer)).ToArray()),
            (typeof(int), Enumerable.Range(0, 100).Select(i =>
                new ExpandedNodeId($"Scalar_Static_Mass_Int32_Int32_{i:D2}", SampleCompany.NodeManagers.Reference.Namespaces.ReferenceServer)).ToArray()),
            (typeof(long), Enumerable.Range(0, 100).Select(i =>
                new ExpandedNodeId($"Scalar_Static_Mass_Int64_Int64_{i:D2}", SampleCompany.NodeManagers.Reference.Namespaces.ReferenceServer)).ToArray()),
            (typeof(ushort), Enumerable.Range(0, 100).Select(i =>
                new ExpandedNodeId($"Scalar_Static_Mass_UInt16_UInt16_{i:D2}", SampleCompany.NodeManagers.Reference.Namespaces.ReferenceServer)).ToArray()),
            (typeof(uint), Enumerable.Range(0, 100).Select(i =>
                new ExpandedNodeId($"Scalar_Static_Mass_UInt32_UInt32_{i:D2}", SampleCompany.NodeManagers.Reference.Namespaces.ReferenceServer)).ToArray()),
            (typeof(ulong), Enumerable.Range(0, 100).Select(i =>
                new ExpandedNodeId($"Scalar_Static_Mass_UInt64_UInt64_{i:D2}", SampleCompany.NodeManagers.Reference.Namespaces.ReferenceServer)).ToArray())
        ];
