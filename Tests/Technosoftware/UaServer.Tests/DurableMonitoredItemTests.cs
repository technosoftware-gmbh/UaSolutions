...
namespace Technosoftware.UaServer.Tests
{
    ...
    public class DurableMonitoredItemTests
    {
        ...
        [
            new object[] { TelemetryParameterizable.Create<IUaMonitoredItemQueueFactory>(t => new MonitoredItemQueueFactory(t)) },
            new object[] { TelemetryParameterizable.Create<IUaMonitoredItemQueueFactory>(t => new DurableMonitoredItemQueueFactory(t)) }
        ];

        public DurableMonitoredItemTests(TelemetryParameterizable<IUaMonitoredItemQueueFactory> factory)
        {
            m_factory = factory;
        }

        private readonly TelemetryParameterizable<IUaMonitoredItemQueueFactory> m_factory;
        ...
        public void EnqueueDequeueDataValue()
        {
            ...
            IUaDataChangeMonitoredItemQueue queue = m_factory.Create(telemetry).CreateDataChangeQueue(false, 1);
        ...
        public void QueueDequeueEvents()
        {
            ...
            IUaEventMonitoredItemQueue queue = m_factory.Create(telemetry).CreateEventQueue(false, 1);
        ...
        public void FactorySupportsDurable()
        {
            ...
            IUaMonitoredItemQueueFactory factory = m_factory.Create(telemetry);
            if (factory.SupportsDurableQueues)
            {
                IUaDataChangeMonitoredItemQueue dataChangeQueue = factory.CreateDataChangeQueue(
                    true,
                    1);

                Assert.That(dataChangeQueue.IsDurable, Is.True);

                IUaEventMonitoredItemQueue eventQueue = factory.CreateEventQueue(true, 1);
        ...
        public void CreateDurableMI()
        {
            ...
            if (factory.SupportsDurableQueues)
            {
                UaMonitoredItem monitoredItem = CreateDurableMonitoredItem(factory, telemetry);
        ...
        public void CreateDurableEventMI()
        {
            ...
            UaMonitoredItem monitoredItem = CreateDurableMonitoredItem(factory, telemetry, true);
            Assert.That(monitoredItem, Is.Not.Null);
            Assert.That(monitoredItem.IsDurable, Is.True);
            Assert.That(monitoredItem.ItemsInQueue, Is.EqualTo(0));
        ...
        public void CreateDurableMIQueueNoQueue()
        {
            ...
            UaMonitoredItem monitoredItem = CreateDurableMonitoredItem(
                factory,
                telemetry,
                false,
                0);
        ...
        public async Task DurableEventQueueVerifyReferenceBatchingAsync()
        {
            ...
            IUaEventMonitoredItemQueue queue = factory.CreateEventQueue(true, 0);
        ...
        public async Task DurableDataValueQueueVerifyReferenceBatchingAsync()
        {
            ...
            IUaDataChangeMonitoredItemQueue queue = factory.CreateDataChangeQueue(true, 0);
        ...
        private static UaMonitoredItem CreateDurableMonitoredItem(
            IUaMonitoredItemQueueFactory factory,
