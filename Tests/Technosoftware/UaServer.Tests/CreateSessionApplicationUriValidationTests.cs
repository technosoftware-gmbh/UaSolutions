...
// http://technosoftware.com/License/MIT/1.00/
//-----------------------------------------------------------------------------
...
namespace Technosoftware.UaServer.Tests
{
    ...
    {
        private const string kClientApplicationUri = "urn:localhost:technosoftware.com:TestClient";
        private const string kClientSubjectName = "CN=TestClient, O=Technosoftware GmbH";
        private ServerFixture<UaStandardServer> m_serverFixture;
        ...
        public async Task CreateSessionWithMatchingApplicationUriSucceedsAsync(NodeId certificateType)
        {
            ...
            UaClient.IUaSession session = await CreateSessionWithCustomCertificateAsync(clientCert, kClientApplicationUri).ConfigureAwait(false);
        ...
        public async Task CreateSessionWithMultipleUrisOneMatchesSucceedsAsync(NodeId certificateType)
        {
            ...
            const string uri1 = "urn:localhost:technosoftware.com:App1";
            ...
            string clientApplicationUri)
        {
            ...
            try
            {
                ...
                ApplicationConfiguration clientConfig = await clientApp
                    .CreateApplicationConfigurationManager(clientApplicationUri, "uri:technosoftware.com:TestClient")
                    .AsClient()
