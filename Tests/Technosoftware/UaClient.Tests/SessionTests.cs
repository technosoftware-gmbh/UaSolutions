...
namespace Technosoftware.UaClient.Tests
{
    ...
    public sealed class SessionTests
    {
        ...
        public async Task FetchNamespaceTablesAsyncShouldFetchAndUpdateTablesAsync()
        {
            ...
            // Assert
            Assert.That(sut.NamespaceUris.ToArray(), Is.EquivalentTo([Opc.Ua.Namespaces.OpcUa, "http://namespace2"]));
        ...
        public async Task FetchNamespaceTablesAsyncShouldFetchAndUpdateTablesAndLogDifferences1Async()
        {
            ...
            // Assert
            Assert.That(sut.NamespaceUris.ToArray(), Is.EquivalentTo([Opc.Ua.Namespaces.OpcUa, "http://namespace2", "http://namespace3"]));
            Assert.That(sut.ServerUris.ToArray(), Is.EquivalentTo(["http://server1", "http://server2"]));
            ...
            // Assert
            Assert.That(sut.NamespaceUris.ToArray(), Is.EquivalentTo([Opc.Ua.Namespaces.OpcUa, "http://namespace3", "http://namespace2"]));
        ...
        public async Task FetchNamespaceTablesAsyncShouldFetchAndUpdateTablesAndLogDifferences2Async()
        {
            ...
            // Assert
            Assert.That(sut.NamespaceUris.ToArray(), Is.EquivalentTo([Opc.Ua.Namespaces.OpcUa, "http://namespace3"]));
