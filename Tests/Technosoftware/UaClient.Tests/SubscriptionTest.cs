...
namespace Technosoftware.UaClient.Tests
{
    ...
    public class SubscriptionTest : ClientTestFramework
    {
            ...
            bool sequentialPublishing)
        {
            ...
            IUaSession originSession = await ClientFixture
                .ConnectAsync(ServerUrl, SecurityPolicies.Basic256Sha256)
                .ConfigureAwait(false);
            IUaSession targetSession = null;
            try
            {
        ...
        private async Task<IUaSession> InternalTransferSubscriptionAsync(
            IUaSession originSession,
            TransferType transferType,
            bool sendInitialValues,
            bool sequentialPublishing)
        {
            ...
            IUaSession targetSession = await ClientFixture
                .ConnectAsync(ServerUrl, SecurityPolicies.Basic256Sha256)
                .ConfigureAwait(false);
            if (transferType == TransferType.DisconnectedRepublishDelayedAck)
            {
