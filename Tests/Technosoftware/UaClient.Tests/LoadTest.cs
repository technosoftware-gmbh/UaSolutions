...
namespace Technosoftware.UaClient.Tests
{
    ...
    public class LoadTest : ClientTestFramework
    {
        ...
        public async Task ServerLoadTestAsync()
        {
            ...
            var sessions = new ConcurrentBag<IUaSession>();
            ...
            try
            {
                ...
                for (int i = 0; i < sessionCount; i++)
                {
                    ...
                    {
                        IUaSession session = await ClientFixture.ConnectAsync(ServerUrl, SecurityPolicies.Basic256Sha256).ConfigureAwait(false);
                ...
                IUaSession writerSession = await ClientFixture.ConnectAsync(ServerUrl, SecurityPolicies.Basic256Sha256).ConfigureAwait(false);
