...
namespace Technosoftware.UaClient.Tests
{
    ...
    {
        private readonly string subscriptionTestXml_ = Path.Combine(Path.GetTempPath(), "SubscriptionTest.xml");
        ...
        public void AddSubscription()
        {
            ...
            // check keepAlive
            int keepAlive = 0;
            Session.SessionKeepAliveEvent += (object sender, SessionKeepAliveEventArgs e) => { keepAlive++; };
            ...
            Session.Save(subscriptionTestXml_, new[] { typeof(TestableSubscription) });
        ...
        public async Task ReconnectWithSavedSessionSecretsAsync(string securityPolicy, bool anonymous, bool sequentialPublishing, bool sendInitialValues, bool asyncTest)
        {
            ...
            session1.SessionConfigurationChangedEvent += (object sender, EventArgs e) => { session1ConfigChanged++; };
            ...
            session2.SessionConfigurationChangedEvent += (object sender, EventArgs e) => { session2ConfigChanged++; };
        ...
        public async Task InternalTransferSubscriptionAsync(TransferType transferType, bool sendInitialValues, bool sequentialPublishing, bool asyncTransfer)
        {
            ...
            {
                originSession.PublishSequenceNumbersToAcknowledgeEvent += DeferSubscriptionAcknowledge;
            }
            ...
            if (transferType == TransferType.DisconnectedRepublishDelayedAck)
            {
                targetSession.PublishSequenceNumbersToAcknowledgeEvent += DeferSubscriptionAcknowledge;
            }
