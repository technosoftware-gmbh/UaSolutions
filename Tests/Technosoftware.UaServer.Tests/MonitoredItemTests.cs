...
namespace Technosoftware.UaServer.Tests
{
    ...
    public class MonitoreItemTests
    {
        ...
        public void CreateMI()
        {
            ...
            monitoredItem.Publish(new UaServerOperationContext(monitoredItem), result, result2, 1);
        ...
        {
            UaMonitoredItem monitoredItem = CreateMonitoredItem(true);
            Assert.That(monitoredItem, Is.Not.Null);
            Assert.That(monitoredItem.ItemsInQueue, Is.EqualTo(0));
        ...
        {
            UaMonitoredItem monitoredItem = CreateMonitoredItem(true, 2);
            Assert.That(monitoredItem, Is.Not.Null);
            Assert.That(monitoredItem.ItemsInQueue, Is.EqualTo(0));
        ...
        {
            UaMonitoredItem monitoredItem = CreateMonitoredItem(true, 2, true);
            Assert.That(monitoredItem, Is.Not.Null);
            Assert.That(monitoredItem.ItemsInQueue, Is.EqualTo(0));
        ...
        {
            UaMonitoredItem monitoredItem = CreateMonitoredItem(true, 3);
            Assert.That(monitoredItem, Is.Not.Null);
            Assert.That(monitoredItem.ItemsInQueue, Is.EqualTo(0));
