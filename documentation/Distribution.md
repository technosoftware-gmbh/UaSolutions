...
The OPC UA Solutions .NET is delivered as a set of [NuGet packages](/nuget/packages). Depending on the targeted .NET Framework you have the following packages available:
...
.NET 9.0 or .NET 6.0 allows you to develop applications that run on all common platforms available today, including Linux, macOS and Windows 11/10
