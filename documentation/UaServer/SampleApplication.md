...
| **Technosoftware.UaSolutions.UaBaseServer**     | The OPC UA Base Server Class library used by the samples explained in [Server Design based on UaBaseServer](./UaBaseServerDesign.md).                    |
| **Technosoftware.UaSolutions.UaStandardServer** | The OPC UA Standard Server Class library used by the samples explained in [Server Design based on UaStandardServer](./UaStandardServerDesign.md).               |
