...
namespace SampleCompany.ReferenceServer
{
    ...
    public class CustomDirectoryCertificateStoreType : ICertificateStoreType
    {
        ...
        {
            return new CustomDirectoryCertificateStore();
        }
    }
    ...
    /// </summary>
    public class CustomDirectoryCertificateStore : ICertificateStore
    {
        ...
        /// </summary>
        public CustomDirectoryCertificateStore() : this(false)
        {
        }
        ...
        /// </summary>
        public CustomDirectoryCertificateStore(bool noSubDirs)
        {
