...
namespace Technosoftware.UaUtilities
{
    ...
    public static class LicenseValidationExtensions
    {
        ...
        /// <summary>
        /// Validates if the m_license has been expired.
        /// </summary>
        /// <param name="validationChain">The current <see cref="IStartValidationChain"/>.</param>
        /// <returns>An instance of <see cref="IStartValidationChain"/>.</returns>
        public static IValidationChain LicenseExpirationDate(this IStartValidationChain validationChain)
        {
            return LicenseExpirationDate(validationChain, DateTime.Now);
        }
        ...
        /// <returns>An instance of <see cref="IStartValidationChain"/>.</returns>
        public static IValidationChain LicenseExpirationDate(this IStartValidationChain validationChain, DateTime systemDateTime)
        {
            ...
            validator.Validate = license => license.LicenseExpirationDate > systemDateTime;
        ...
        /// exceeded the <see cref="License.LicenseExpirationDate"/> date.
        /// </summary>
        /// <param name="validationChain">The current <see cref="IStartValidationChain"/>.</param>
        ...
        public static IValidationChain ProductBuildDate(this IStartValidationChain validationChain, Assembly[] assemblies)
        {
            ...
            validator.Validate = license => assemblies.All(
                    ...
                    asm.GetCustomAttributes(typeof(AssemblyBuildDateAttribute), false)
                       ...
                       .All(a => a.BuildDate < license.LicenseExpirationDate));
