...
{
    /// <summary>
    /// The license information of a <see cref="License"/>.
    /// </summary>
    public class LicenseInfo : LicenseAttributes
    {
        internal LicenseInfo(XElement xmlData)
            : base(xmlData, "License")
        {
        }

        /// <summary>
        /// Gets or sets the level of this <see cref="LicenseInfo"/>.
        /// </summary>
        public string Level
        {
        ...
        /// <summary>
        /// Gets or sets the expiration date of this <see cref="LicenseInfo"/>.
        /// </summary>
