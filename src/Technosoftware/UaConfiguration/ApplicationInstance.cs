...
{
    /// <inheritdoc/>
    public class ApplicationInstance : IUaApplicationInstance
    {
        ...
        /// <inheritdoc/>
        public IUaApplicationConfigurationTypes CreateApplicationConfigurationManager(
            ...
            CancellationToken ct)
        {
            ...
            catch (Exception e)
            {
                m_logger.LogError(
                    ...
                    Opc.Ua.Redaction.Redact.Create(e));
            }
        }
