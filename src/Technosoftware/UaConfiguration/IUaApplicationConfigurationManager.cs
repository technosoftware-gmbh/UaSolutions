...
namespace Technosoftware.UaConfiguration
{
    ...
    public interface IUaApplicationConfigurationManager
        : IUaApplicationConfigurationTypes,
    ...
    /// </summary>
    public interface IUaApplicationConfigurationTypes
            ...
            IUaApplicationConfigurationClient
    {
        ...
        IUaApplicationConfigurationTransportQuotasSet SetTransportQuotas(
        ...
        IUaApplicationConfigurationTransportQuotas SetMaxByteStringLength(
        ...
        IUaApplicationConfigurationTransportQuotas SetMaxEncodingNestingLevels(
        ...
        IUaApplicationConfigurationTransportQuotas SetMaxDecoderRecoveries(
        ...
        IUaApplicationConfigurationTransportQuotas SetSecurityTokenLifetime(
            ...
            IUaApplicationConfigurationSecurity
    {
        ...
        IUaApplicationConfigurationServerOptions SetMinRequestThreadCount(
            int minRequestThreadCount);

        /// <inheritdoc cref="ServerBaseConfiguration.MaxRequestThreadCount"/>
        IUaApplicationConfigurationServerOptions SetMaxRequestThreadCount(
            int maxRequestThreadCount);

        /// <inheritdoc cref="ServerBaseConfiguration.MaxQueuedRequestCount"/>
        IUaApplicationConfigurationServerOptions SetMaxQueuedRequestCount(
            int maxQueuedRequestCount);

        /// <inheritdoc cref="ServerConfiguration.DiagnosticsEnabled"/>
        IUaApplicationConfigurationServerOptions SetDiagnosticsEnabled(
        ...
        IUaApplicationConfigurationServerOptions SetMaxBrowseContinuationPoints(
            int maxBrowseContinuationPoints);

        /// <inheritdoc cref="ServerConfiguration.MaxQueryContinuationPoints"/>
        IUaApplicationConfigurationServerOptions SetMaxQueryContinuationPoints(
            int maxQueryContinuationPoints);

        /// <inheritdoc cref="ServerConfiguration.MaxHistoryContinuationPoints"/>
        IUaApplicationConfigurationServerOptions SetMaxHistoryContinuationPoints(
        ...
        IUaApplicationConfigurationServerOptions AddServerCapabilities(
        ...
        IUaApplicationConfigurationServerOptions SetHttpsMutualTls(bool mTlsEnabled);

        /// <inheritdoc cref="ServerConfiguration.DurableSubscriptionsEnabled"/>
        IUaApplicationConfigurationServerOptions SetDurableSubscriptionsEnabled(
            bool durableSubscriptionsEnabled);

        /// <inheritdoc cref="ServerConfiguration.MaxDurableNotificationQueueSize"/>
        IUaApplicationConfigurationServerOptions SetMaxDurableNotificationQueueSize(
            int maxDurableNotificationQueueSize);

        /// <inheritdoc cref="ServerConfiguration.MaxDurableEventQueueSize"/>
        IUaApplicationConfigurationServerOptions SetMaxDurableEventQueueSize(
            int maxDurableEventQueueSize);

        /// <inheritdoc cref="ServerConfiguration.MaxDurableSubscriptionLifetimeInHours"/>
        IUaApplicationConfigurationServerOptions SetMaxDurableSubscriptionLifetime(
    ...
    /// </summary>
    public interface IUaApplicationConfigurationClientOptions : IUaApplicationConfigurationSecurity
    {
        /// <inheritdoc cref="ClientConfiguration.DefaultSessionTimeout"/>
        IUaApplicationConfigurationClientOptions SetDefaultSessionTimeout(
        ...
        IUaApplicationConfigurationClientOptions AddWellKnownDiscoveryUrls(
    ...
    public interface IUaApplicationConfigurationServerPolicies
    {
        ...
        /// </summary>
        /// <param name="addPolicies">Add policies if true.</param>
        IUaApplicationConfigurationServerSelected AddSignAndEncryptPolicies(
        ...
        /// </remarks>
        IUaApplicationConfigurationServerSelected AddEccSignPolicies();
        ...
        /// The policies are only added if the platform supports the ECC policies.
        /// </remarks>
        IUaApplicationConfigurationServerSelected AddEccSignAndEncryptPolicies();
        ...
        IUaApplicationConfigurationServerSelected AddPolicy(
        ...
        IUaApplicationConfigurationServerSelected AddUserTokenPolicy(
    ...
    public interface IUaApplicationConfigurationSecurityOptions
        : IUaApplicationConfigurationGlobalConfiguration,
            ...
            IUaApplicationConfigurationExtension
    {
        ...
        /// </param>
        IUaApplicationConfigurationSecurityOptions SetMaxRejectedCertificates(
        ...
        IUaApplicationConfigurationSecurityOptions SetAutoAcceptUntrustedCertificates(
            bool autoAccept);
        ...
        IUaApplicationConfigurationSecurityOptions SetAddAppCertToTrustedStore(
        ...
        IUaApplicationConfigurationSecurityOptions SetRejectSHA1SignedCertificates(
        ...
        IUaApplicationConfigurationSecurityOptions SetRejectUnknownRevocationStatus(
        ...
        IUaApplicationConfigurationSecurityOptions SetUseValidatedCertificates(
        ...
        IUaApplicationConfigurationSecurityOptions SetSuppressNonceValidationErrors(
        ...
        IUaApplicationConfigurationSecurityOptions SetSendCertificateChain(
        ...
        IUaApplicationConfigurationSecurityOptions SetMinimumCertificateKeySize(
            ushort keySize);
        ...
        IUaApplicationConfigurationSecurityOptions AddCertificatePasswordProvider(
    ...
    /// </summary>
    public interface IUaApplicationConfigurationExtension : IUaApplicationConfigurationTraceConfiguration
    {
        /// <summary>
    ...
    /// </summary>
    public interface IUaApplicationConfigurationGlobalConfiguration
        : IUaApplicationConfigurationCreate,
            IUaApplicationConfigurationTraceConfiguration
    {
        ...
        IUaApplicationConfigurationGlobalConfiguration SetHiResClockDisabled(
    ...
    /// </summary>
    public interface IUaApplicationConfigurationTraceConfiguration : IUaApplicationConfigurationCreate
    {
