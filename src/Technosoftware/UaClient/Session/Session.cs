...
namespace Technosoftware.UaClient
{
        ...
        ISnapshotRestore<SessionState>, ISnapshotRestore<SessionConfiguration>
    {
        ...
        ///     Raised when a subscription is added or removed
        /// </summary>
        [Obsolete("Use SubscriptionsChanged")]
        ...
        [Obsolete]
        private event EventHandler<SessionKeepAliveEventArgs>? m_KeepAliveEvent;
        [Obsolete]
        private event EventHandler<SessionNotificationEventArgs>? m_PublishEvent;
        [Obsolete]
        private event EventHandler<SessionPublishErrorEventArgs>? m_PublishErrorEvent;
        [Obsolete]
