...
namespace Technosoftware.UaClient
{
    ...
    public static class SessionObsolete
    {
        ...
        public static void Reconnect(this IUaSession session)
        {
        ...
        /// </summary>
        [Obsolete("Use ReconnectAsync instead.")]
        public static void Reconnect(this IUaSession session, ITransportWaitingConnection connection)
        {
        ...
        /// </summary>
        [Obsolete("Use ReconnectAsync instead.")]
        public static void Reconnect(this IUaSession session, ITransportChannel channel)
        {
        ...
        public static void FetchNamespaceTables(this IUaSession session)
        {
        ...
        public static void FetchTypeTree(this IUaSession session, ExpandedNodeId typeId)
        {
        ...
        /// </summary>
        [Obsolete("Use FetchTypeTreeAsync instead.")]
        public static void FetchTypeTree(this IUaSession session, ExpandedNodeIdCollection typeIds)
        {
        ...
        public static Node ReadNode(this IUaSession session, NodeId nodeId)
        {
        ...
        public static DataValue ReadValue(this IUaSession session, NodeId nodeId)
        {
        ...
        [Obsolete("Use ReadValueAsync instead.")]
        public static object ReadValue(this IUaSession session, NodeId nodeId, Type expectedType)
        {
        ...
        /// </summary>
        public static void FindComponentIds(this IUaSession session,
            NodeId instanceId,
        ...
        public static void ReadValues(this IUaSession session,
        ...
        /// </summary>
        [Obsolete("Use Use ReadValuesAsync instead.")]
        public static void ReadDisplayName(this IUaSession session,
            IList<NodeId> nodeIds,
        ...
        /// </summary>
        [Obsolete("Use CloseAsync instead.")]
        public static StatusCode Close(this IUaSession session, int timeout)
        {
        ...
        /// </summary>
        [Obsolete("Use CloseAsync instead.")]
        public static StatusCode Close(this IUaSession session, bool closeChannel)
        {
    ...
    public partial class Session
    {
        ...
        /// </summary>
        [Obsolete("Use IUaSessionFactory.CreateAsync")]
        ...
        [Obsolete("Use IUaSessionFactory.RecreateAsync")]
        ...
        /// </summary>
        [Obsolete("Use IUaSessionFactory.Create")]
        public static Session Create(
            IUaSessionInstantiator sessionInstantiator,
            ApplicationConfiguration configuration,
            ITransportChannel channel,
        ...
        /// </summary>
        [Obsolete("Use IUaSessionFactory.CreateChannelAsync")]
    ...
    /// </summary>
    [Obsolete("Use IUaSessionFactory instead. This interface will be removed in a future release.")]
    public interface IUaSessionInstantiator : IUaSessionFactory;
    ...
    public static class SessionFactoryObsolete
    {
        ...
        public static IUaSession Create(
            this IUaSessionFactory factory,
            ApplicationConfiguration configuration,
            ITransportChannel channel,
            ConfiguredEndpoint endpoint,
            X509Certificate2 clientCertificate,
