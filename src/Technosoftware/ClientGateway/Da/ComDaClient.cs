...
namespace Technosoftware.ClientGateway.Da
{
    ...
    /// </summary>
    /// <exclude />
    internal class ComDaClient : ComClient
    {
        #region Constructors
        /// <summary>
        ...
        public ComDaClient(ComDaClientConfiguration configuration, ITelemetryContext telemetry) : base(configuration, telemetry)
        {
            m_cache = new Dictionary<string, DaElement>();
            m_configuration = configuration;
            m_telemetry = telemetry;
            m_logger = telemetry.CreateLogger<ComDaClient>();
        }
        ...
        {
            ComDaClient clone = new ComDaClient(m_configuration, Telemetry);
        ...
        public OPCSERVERSTATUS? GetStatus()
        {
            ...
            try
            {
                ...
                Technosoftware.Rcw.OPCSERVERSTATUS pStatus = (Technosoftware.Rcw.OPCSERVERSTATUS)Marshal.PtrToStructure(
                    ppServerStatus,
                    typeof(Technosoftware.Rcw.OPCSERVERSTATUS));

                Marshal.DestroyStructure(ppServerStatus, typeof(Technosoftware.Rcw.OPCSERVERSTATUS));
            ...
            out int revisedSamplingInterval)
        {
            ...
            try
            {
                ...
                object group = null;
                Guid iid = typeof(Technosoftware.Rcw.IOPCItemMgt).GUID;
        ...
        private DaValue[] ReadPropertyValues(string itemId, params int[] propertyIds)
        {
            ...
            catch (Exception e)
            {
                ...
                for (int ii = 0; ii < count; ii++)
                {
                    ...
                    result.Value = null;
                    result.Quality = Technosoftware.Rcw.Qualities.OPC_QUALITY_GOOD;
        ...
        private void Da20ReadItemValues(List<ReadRequest> requests)
        {
            // lock (m_groupLock)
            {
                // if (m_group == null)
                //{                
                ComDaGroup m_group = new ComDaGroup(this, false, m_telemetry);
                //}
        ...
        private void Da30WriteItemValues(List<WriteRequest> requests)
        {
            int count = 0;
            string[] itemIDs = new string[requests.Count];
            Technosoftware.Rcw.OPCITEMVQT[] values = new Technosoftware.Rcw.OPCITEMVQT[requests.Count];
        ...
        private class Da20ElementBrowser : IDaElementBrowser
        {
            ...
            #endregion IDaElementBrowser Members
        ...
        #endregion Da20ElementBrowser Class
    ...
    /// </summary>
    internal interface IDaElementBrowser : IDisposable
    {
        /// <summary>
