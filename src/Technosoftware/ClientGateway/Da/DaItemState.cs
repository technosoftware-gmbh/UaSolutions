...
namespace Technosoftware.ClientGateway.Da
{
    ...
    /// </summary>
    internal partial class DaItemState : BaseDataVariableState
    {
        #region Constructors
        /// <summary>
        ...
        public void Initialize(ISystemContext context, DaElement element, ushort namespaceIndex)
        {
            ...
            switch (element.ElementType)
            {
                ...
                case DaElementType.EnumeratedItem:
                {
                    ...
                    {
                        PropertyState property = this.AddProperty<LocalizedText[]>(
                            Opc.Ua.BrowseNames.EnumStrings,
            ...
            if ((element.AccessRights & Technosoftware.Rcw.Constants.OPC_READABLE) != 0)
            {
                this.AccessLevel |= AccessLevels.CurrentRead;
            }

            if ((element.AccessRights & Technosoftware.Rcw.Constants.OPC_WRITEABLE) != 0)
            {
