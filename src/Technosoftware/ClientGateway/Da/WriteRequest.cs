...
namespace Technosoftware.ClientGateway.Da
{
    ...
    internal class WriteRequest
    {
        ...
        private StatusCode MapWriteErrorToServiceResult(int error)
        {
            ...
            switch (error)
            {
                ...
                { return StatusCodes.BadNodeIdInvalid; }
                case ResultIds.E_NOTSUPPORTED:
                { return StatusCodes.BadWriteNotSupported; }
                case ResultIds.S_CLAMP:
                { return StatusCodes.GoodClamped; }
                case ResultIds.E_FILTER_DUPLICATE:
                { return StatusCodes.BadTypeMismatch; }
                case ResultIds.E_FILTER_INVALID:
                { return StatusCodes.BadTypeMismatch; }
                case ResultIds.E_FILTER_ERROR:
                { return StatusCodes.BadTypeMismatch; }
            }
    ...
    /// </summary>
    internal class WriteRequestCollection : List<WriteRequest>
    {
        #region Public Methods
        /// <summary>
