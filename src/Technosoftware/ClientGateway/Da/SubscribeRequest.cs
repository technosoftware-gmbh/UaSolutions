...
using ReadRequest = Technosoftware.ClientGateway.Da.ReadRequest;
...
namespace Technosoftware.ClientGateway.Da
{
    ...
    internal class SubscribeItemRequest
    {
        ...
        public List<Technosoftware.UaServer.UaMonitoredItem> MonitoredItems
        {
        ...
        public void Add(Technosoftware.UaServer.UaMonitoredItem monitoredItem)
        {
            if (m_monitoredItems == null)
            {
                m_monitoredItems = new List<Technosoftware.UaServer.UaMonitoredItem>();
            }
        ...
        /// </summary>
        /// <param name="monitoredItem">The monitored item.</param>
        public void Modify(Technosoftware.UaServer.UaMonitoredItem monitoredItem)
        {
            m_changed = true;
        }
        ...
        /// </summary>
        /// <param name="monitoredItem">The monitored item.</param>
        public void Remove(Technosoftware.UaServer.UaMonitoredItem monitoredItem)
        {
        ...
        public void ChangesComplete()
        {
            if (m_group != null && m_monitoredItems != null)
            {
                ...
                for (int ii = 0; ii < m_monitoredItems.Count; ii++)
                {
                    ...
                    if ((actualSamplingInterval > 0) &&
                         (samplingInterval % actualSamplingInterval != 0))
                    {
        ...
        public void Update()
        {
            ...
            {
                Technosoftware.UaServer.UaMonitoredItem monitoredItem = MonitoredItems[ii];
        ...
        private List<Technosoftware.UaServer.UaMonitoredItem> m_monitoredItems;
    ...
    /// </summary>
    internal class SubscribePropertyRequest
    {
        #region Constructors
        /// <summary>
        ...
        public void QueueValues(UaServerContext context, ReadRequest request)
        {
            for (int ii = 0; ii < m_monitoredItems.Count; ii++)
            {
        ...
        /// <param name="request">The request.</param>
        /// <param name="monitoredItem">The monitored item.</param>
        public void QueueValue(UaServerContext context, ReadRequest request, Technosoftware.UaServer.UaMonitoredItem monitoredItem)
        {
            UaNodeHandle handle = monitoredItem.ManagerHandle as UaNodeHandle;
        ...
        /// <param name="context">The context.</param>
        /// <param name="monitoredItem">The monitored item.</param>
        public void Add(UaServerContext context, Technosoftware.UaServer.UaMonitoredItem monitoredItem)
        {
        ...
        /// <param name="context">The context.</param>
        /// <param name="monitoredItem">The monitored item.</param>
        public void Modify(UaServerContext context, Technosoftware.UaServer.UaMonitoredItem monitoredItem)
        {
        ...
        /// <param name="context">The context.</param>
        /// <param name="monitoredItem">The monitored item.</param>
        public void Remove(UaServerContext context, Technosoftware.UaServer.UaMonitoredItem monitoredItem)
        {
        ...
        internal static int DaItemAttributeToDaProperty(uint attributeId)
        {
            switch (attributeId)
            {
                ...
                {
                    return Technosoftware.Common.PropertyIds.Value;
                }

                case Attributes.Description:
                {
                    return Technosoftware.Common.PropertyIds.Description;
                }

                case Attributes.DataType:
                case Attributes.ValueRank:
                {
                    return Technosoftware.Common.PropertyIds.DataType;
                }

                case Attributes.AccessLevel:
                case Attributes.UserAccessLevel:
                {
                    return Technosoftware.Common.PropertyIds.AccessRights;
                }

                case Attributes.MinimumSamplingInterval:
                {
                    return Technosoftware.Common.PropertyIds.ScanRate;
                }
            }
        ...
        internal static int[] UaPropertyToDaProperty(string symbolicName)
        {
            switch (symbolicName)
            {
                ...
                { return s_PropertyMapping_EURange; }
                case Opc.Ua.BrowseNames.InstrumentRange:
                { return s_PropertyMapping_InstrumentRange; }
                case Opc.Ua.BrowseNames.EngineeringUnits:
                { return s_PropertyMapping_EngineeringUnits; }
                case Opc.Ua.BrowseNames.EnumStrings:
                { return s_PropertyMapping_EnumStrings; }
                case Opc.Ua.BrowseNames.LocalTime:
                { return s_PropertyMapping_TimeZone; }
                case Opc.Ua.BrowseNames.TrueState:
                { return s_PropertyMapping_TrueState; }
                case Opc.Ua.BrowseNames.FalseState:
                { return s_PropertyMapping_FalseState; }
            }

            return null;
        }

        private static int[] s_PropertyMapping_EURange = new int[] { Technosoftware.Common.PropertyIds.HighEU, Technosoftware.Common.PropertyIds.LowEU };
        private static int[] s_PropertyMapping_InstrumentRange = new int[] {
            Technosoftware.Common.PropertyIds.HighIR,
            Technosoftware.Common.PropertyIds.LowIR };
        private static int[] s_PropertyMapping_EngineeringUnits = new int[] { Technosoftware.Common.PropertyIds.EngineeringUnits };
        private static int[] s_PropertyMapping_EnumStrings = new int[] { Technosoftware.Common.PropertyIds.EuInfo };
        private static int[] s_PropertyMapping_TimeZone = new int[] { Technosoftware.Common.PropertyIds.TimeZone };
        private static int[] s_PropertyMapping_TrueState = new int[] { Technosoftware.Common.PropertyIds.CloseLabel };
        private static int[] s_PropertyMapping_FalseState = new int[] { Technosoftware.Common.PropertyIds.OpenLabel };
    ...
    internal class SubscribeRequestManager : IDisposable
    {
        ...
        public SubscribeRequestManager(UaServerContext context, ComClient client, int propertySamplingInterval, ITelemetryContext telemetry)
        {
            m_context = context;
            ...
            m_monitoredItems = new Dictionary<uint, IUaMonitoredItem>();
            m_telemetry = telemetry;
            m_logger = telemetry.CreateLogger<SubscribeRequestManager>();
        ...
        public void RecreateItems()
        {
            lock (m_lock)
            {
                ...
                IList<IUaMonitoredItem> monitoredItems = new List<IUaMonitoredItem>(m_monitoredItems.Values);
        ...
        public void CreateItems(UaServerContext context, IList<IUaMonitoredItem> monitoredItems)
        {
        ...
        /// <param name="context">The context.</param>
        /// <param name="monitoredItems">The monitored items.</param>
        public void ModifyItems(UaServerContext context, IList<IUaMonitoredItem> monitoredItems)
        {
            ComDaClientManager system = (ComDaClientManager)context.SystemHandle;
            ComDaClient client = (ComDaClient)system.GetLocalizedClient(this.UserIdentity, this.LocaleId);
        ...
        /// <param name="context">The context.</param>
        /// <param name="monitoredItems">The monitored items.</param>
        public void DeleteItems(UaServerContext context, IList<IUaMonitoredItem> monitoredItems)
        {
            ComDaClientManager system = (ComDaClientManager)context.SystemHandle;
            ComDaClient client = (ComDaClient)system.GetLocalizedClient(this.UserIdentity, this.LocaleId);
        ...
        /// <param name="monitoredItem">The monitored item.</param>
        public void Add(NodeState source, Technosoftware.UaServer.UaMonitoredItem monitoredItem)
        {
            lock (m_lock)
            {
        ...
        /// <param name="source">The source.</param>
        /// <param name="monitoredItem">The monitored item.</param>
        public void Modify(NodeState source, Technosoftware.UaServer.UaMonitoredItem monitoredItem)
        {
            lock (m_lock)
            {
                DaItemState item = source as DaItemState;
        ...
        /// <param name="source">The source.</param>
        /// <param name="monitoredItem">The monitored item.</param>
        public void Remove(NodeState source, Technosoftware.UaServer.UaMonitoredItem monitoredItem)
        {
            lock (m_lock)
            {
        ...
        public void UpdateGroup(ComDaClient client, SubscribeItemRequest request)
        {
            lock (m_lock)
            {
                ...
                // create a new group.
                request.Group = new ComDaGroup(client, true, m_telemetry);
        ...
        private void OnScanProperties(object state)
        {
            ...
            {
                m_logger.LogError(e, "Unexpected error scanning properties in DA COM server.");
            }
        }
        ...
        /// <param name="monitoredItem">The monitored item.</param>
        private void Add(DaItemState item, Technosoftware.UaServer.UaMonitoredItem monitoredItem)
        {
        ...
        /// <param name="monitoredItem">The monitored item.</param>
        private void Add(DaPropertyState item, Technosoftware.UaServer.UaMonitoredItem monitoredItem)
        {
            if (monitoredItem.AttributeId != Attributes.Value)
            {
                return;
        ...
        /// <param name="monitoredItem">The monitored item.</param>
        private void Add(PropertyState property, Technosoftware.UaServer.UaMonitoredItem monitoredItem)
        {
            if (monitoredItem.AttributeId != Attributes.Value)
            {
                return;
        ...
        /// <param name="item">The item.</param>
        /// <param name="monitoredItem">The monitored item.</param>
        private void Modify(DaItemState item, Technosoftware.UaServer.UaMonitoredItem monitoredItem)
        {
            if (monitoredItem.AttributeId == Attributes.Value)
            {
        ...
        /// <param name="item">The item property.</param>
        /// <param name="monitoredItem">The monitored item.</param>
        private void Modify(DaPropertyState item, Technosoftware.UaServer.UaMonitoredItem monitoredItem)
        {
            if (monitoredItem.AttributeId != Attributes.Value)
            {
                return;
        ...
        /// <param name="property">The property.</param>
        /// <param name="monitoredItem">The monitored item.</param>
        private void Modify(PropertyState property, Technosoftware.UaServer.UaMonitoredItem monitoredItem)
        {
            if (monitoredItem.AttributeId != Attributes.Value)
            {
                return;
        ...
        /// <param name="item">The item.</param>
        /// <param name="monitoredItem">The monitored item.</param>
        private void Remove(DaItemState item, Technosoftware.UaServer.UaMonitoredItem monitoredItem)
        {
            if (monitoredItem.AttributeId == Attributes.Value)
            {
                SubscribeItemRequest request = FindItemRequest(item.ItemId, false);
        ...
        /// <param name="item">The item property.</param>
        /// <param name="monitoredItem">The monitored item.</param>
        private void Remove(DaPropertyState item, Technosoftware.UaServer.UaMonitoredItem monitoredItem)
        {
            if (monitoredItem.AttributeId != Attributes.Value)
            {
                return;
        ...
        /// <param name="property">The property.</param>
        /// <param name="monitoredItem">The monitored item.</param>
        private void Remove(PropertyState property, Technosoftware.UaServer.UaMonitoredItem monitoredItem)
        {
            if (monitoredItem.AttributeId != Attributes.Value)
            {
                return;
        ...
        private UaServerContext m_context;
        private Dictionary<uint, IUaMonitoredItem> m_monitoredItems;
