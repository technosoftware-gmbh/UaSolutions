...
namespace Technosoftware.ClientGateway.Da
{
    ...
    internal class ReadRequest
    {
        ...
        public static ServiceResult GetItemValue(DaValue daValue, DataValue uaValue, DiagnosticsMasks diagnosticsMasks)
        {
            ...
            if (daValue.Quality != Technosoftware.Rcw.Qualities.OPC_QUALITY_GOOD)
            {
            ...
            DiagnosticsMasks diagnosticsMasks)
        {
            ...
            switch (nodeToRead.AttributeId)
            {
                ...
                {
                    string description = this.GetPropertyValue<string>(Technosoftware.Common.PropertyIds.Description, value, false);
                ...
                {
                    short datatype = this.GetPropertyValue<short>(Technosoftware.Common.PropertyIds.DataType, value, false);
                ...
                {
                    int accessRights = this.GetPropertyValue<int>(Technosoftware.Common.PropertyIds.AccessRights, value, false);
                ...
                {
                    float scanRate = this.GetPropertyValue<float>(Technosoftware.Common.PropertyIds.ScanRate, value, false);
            ...
            DiagnosticsMasks diagnosticsMasks)
        {
            ...
            switch (property.SymbolicName)
            {
                ...
                {
                    double high = this.GetPropertyValue<double>(Technosoftware.Common.PropertyIds.HighEU, value, true);
                    ...
                    double low = this.GetPropertyValue<double>(Technosoftware.Common.PropertyIds.LowEU, value, true);
                ...
                {
                    double high = this.GetPropertyValue<double>(Technosoftware.Common.PropertyIds.HighIR, value, true);
                    ...
                    double low = this.GetPropertyValue<double>(Technosoftware.Common.PropertyIds.LowIR, value, true);
                ...
                {
                    string units = this.GetPropertyValue<string>(Technosoftware.Common.PropertyIds.EngineeringUnits, value, true);
                    ...
                    value.Value = new EUInformation(units, Technosoftware.Common.Namespaces.ComInterop);
                    break;
                }

                case Opc.Ua.BrowseNames.EnumStrings:
                {
                    string[] strings = this.GetPropertyValue<string[]>(Technosoftware.Common.PropertyIds.EuInfo, value, true);
                ...
                {
                    int timebias = this.GetPropertyValue<int>(Technosoftware.Common.PropertyIds.TimeZone, value, true);
                ...
                {
                    string description = this.GetPropertyValue<string>(Technosoftware.Common.PropertyIds.CloseLabel, value, false);
                ...
                {
                    string description = this.GetPropertyValue<string>(Technosoftware.Common.PropertyIds.OpenLabel, value, false);
            ...
            DiagnosticsMasks diagnosticsMasks)
        {
            ...
            switch (error)
            {
                case ResultIds.E_OUTOFMEMORY:
                { return StatusCodes.BadOutOfMemory; }
                case ResultIds.E_INVALIDHANDLE:
                { return StatusCodes.BadNodeIdUnknown; }
                case ResultIds.E_BADRIGHTS:
                { return StatusCodes.BadNotReadable; }
                case ResultIds.E_UNKNOWNITEMID:
                { return StatusCodes.BadNodeIdUnknown; }
                case ResultIds.E_INVALIDITEMID:
                { return StatusCodes.BadNodeIdInvalid; }
                case ResultIds.E_INVALID_PID:
                { return StatusCodes.BadNodeIdInvalid; }
                case ResultIds.E_ACCESSDENIED:
    ...
    /// </summary>
    internal class ReadRequestCollection : List<ReadRequest>
    {
        #region Public Methods
        /// <summary>
