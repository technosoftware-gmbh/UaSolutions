...
namespace Technosoftware.ClientGateway.Ae
{
    ...
    internal class ComAeSubscriptionClient : ComObject
    {
        ...
        public ComAeSubscriptionClient(
            ...
            Technosoftware.UaServer.UaMonitoredItem monitoredItem,
            ITelemetryContext telemetry) : base(telemetry)
        {
            ...
            m_isSource = false;
            m_telemetry = context.Telemetry;
            m_logger = m_telemetry.CreateLogger<ComAeSubscriptionClient>();
        ...
        public void Create()
        {
            ...
            try
            {
                m_callback = new ComAeEventSink(this, m_telemetry);
            }
            catch (Exception e)
            {
                m_logger.LogError(e, "Could not establish event callback.");
            }
        }
        ...
        /// </summary>
        public void AddItem(Technosoftware.UaServer.UaMonitoredItem monitoredItem)
        {
        ...
        /// </summary>
        public int RemoveItem(Technosoftware.UaServer.UaMonitoredItem monitoredItem)
        {
            lock (m_monitoredItems)
            {
        ...
        {
            BinaryEncoder encoder = new BinaryEncoder(new ServiceMessageContext(m_telemetry));
        ...
        private UaServerContext m_defaultContext;
