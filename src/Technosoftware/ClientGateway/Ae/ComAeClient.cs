...
namespace Technosoftware.ClientGateway.Ae
{
    ...
    /// </summary>
    /// <exclude />
    internal class ComAeClient : ComClient
    {
        #region Constructors
        /// <summary>
        ...
        public ComAeClient(ComAeClientConfiguration configuration, ITelemetryContext telemetry) : base(configuration, telemetry)
        {
        ...
        public ComAeClient CloneClient(ITelemetryContext telemetry)
        {
            return new ComAeClient(m_configuration, telemetry);
        }
            ...
            LocalizedText comment)
        {
            ...
            // unpack the event id.
            ServiceMessageContext messageContext = new ServiceMessageContext(Telemetry);
