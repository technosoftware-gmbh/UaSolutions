	...
	public class PropertyIds
    {
        ...
        public static NodeId GetDataTypeId(int propertyId)
        {
            switch (propertyId)
            {
                ...
                { return DataTypes.Int32; }
                case PropertyIds.ConditionStatus:
                { return DataTypes.String; }
                case PropertyIds.AlarmQuickHelp:
                { return DataTypes.String; }
                case PropertyIds.AlarmAreaList:
                { return DataTypes.String; }
                case PropertyIds.PrimaryAlarmArea:
                { return DataTypes.String; }
                case PropertyIds.ConditionLogic:
                { return DataTypes.String; }
                case PropertyIds.LimitExceeded:
                { return DataTypes.String; }
                case PropertyIds.Deadband:
                { return DataTypes.Double; }
                case PropertyIds.HiHiLimit:
                { return DataTypes.Double; }
                case PropertyIds.HiLimit:
                { return DataTypes.Double; }
                case PropertyIds.LoLimit:
                { return DataTypes.Double; }
                case PropertyIds.LoLoLimit:
                { return DataTypes.Double; }
                case PropertyIds.RateChangeLimit:
                { return DataTypes.Double; }
                case PropertyIds.DeviationLimit:
                { return DataTypes.Double; }
                case PropertyIds.SoundFile:
                { return DataTypes.String; }
                case PropertyIds.TypeSystemId:
                { return DataTypes.String; }
                case PropertyIds.DictionaryId:
                { return DataTypes.String; }
                case PropertyIds.TypeId:
                { return DataTypes.String; }
                case PropertyIds.Dictionary:
                { return DataTypes.String; }
                case PropertyIds.TypeDescription:
                { return DataTypes.String; }
                case PropertyIds.ConsistencyWindow:
                { return DataTypes.String; }
                case PropertyIds.WriteBehavoir:
                { return DataTypes.String; }
                case PropertyIds.UnconvertedItemId:
                { return DataTypes.String; }
                case PropertyIds.UnfilteredItemId:
                { return DataTypes.String; }
                case PropertyIds.DataFilterValue:
                { return DataTypes.String; }
                case PropertyIds.UaBuiltInType:
                { return DataTypes.Int32; }
                case PropertyIds.UaDataTypeId:
                { return DataTypes.String; }
                case PropertyIds.UaValueRank:
                { return DataTypes.Int32; }
                case PropertyIds.UaBrowseName:
                { return DataTypes.String; }
                case PropertyIds.UaDescription:
                { return DataTypes.String; }
            }
        ...
        public static string GetDescription(int propertyId)
        {
            ...
            {
                case PropertyIds.DataType:
                { return "Item Canonical DataType"; }
                case PropertyIds.Value:
                { return "Item Value"; }
                case PropertyIds.Quality:
                { return "Item Quality"; }
                ...
                case PropertyIds.CloseLabel:
                { return "Contact Close Label"; }
                case PropertyIds.OpenLabel:
                { return "Contact Open Label"; }
                case PropertyIds.TimeZone:
                { return "Timezone"; }
                case PropertyIds.ConditionStatus:
                { return "Condition ErrorId"; }
                case PropertyIds.AlarmQuickHelp:
                { return "Alarm Quick Help"; }
                case PropertyIds.AlarmAreaList:
                { return "Alarm Area List"; }
                case PropertyIds.PrimaryAlarmArea:
                { return "Primary Alarm Area"; }
                case PropertyIds.ConditionLogic:
                ...
                case PropertyIds.ConsistencyWindow:
                { return "Consistency Window"; }
                case PropertyIds.WriteBehavoir:
                { return "Write Behavior"; }
                case PropertyIds.UnconvertedItemId:
                { return "Unconverted Item Id"; }
                case PropertyIds.UnfilteredItemId:
                { return "Unfiltered Item Id"; }
                case PropertyIds.DataFilterValue:
                { return "Data Filter Value"; }
                case PropertyIds.UaBuiltInType:
                { return "UA BuiltIn Type"; }
                case PropertyIds.UaDataTypeId:
                { return "UA Data Type Id"; }
                case PropertyIds.UaValueRank:
                { return "UA Value Rank"; }
                case PropertyIds.UaBrowseName:
                { return "UA Browse Name"; }
                case PropertyIds.UaDescription:
