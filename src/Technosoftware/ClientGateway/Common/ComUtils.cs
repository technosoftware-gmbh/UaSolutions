...
namespace Technosoftware.Common
{
    ...
    public class ComUtils
    {
        ...
        #endregion NetApi Function Declarations
        ...
        #endregion OLE32 Function/Interface Declarations
        ...
        public static NodeId GetHdaAggregateId(uint aggregateId)
        {
            ...
            {
                case OPCHDA_AGGREGATE.OPCHDA_INTERPOLATIVE:
                { return Opc.Ua.ObjectIds.AggregateFunction_Interpolative; }
                case OPCHDA_AGGREGATE.OPCHDA_TOTAL:
                { return Opc.Ua.ObjectIds.AggregateFunction_Total; }
                case OPCHDA_AGGREGATE.OPCHDA_AVERAGE:
                { return Opc.Ua.ObjectIds.AggregateFunction_Average; }
                case OPCHDA_AGGREGATE.OPCHDA_TIMEAVERAGE:
                { return Opc.Ua.ObjectIds.AggregateFunction_TimeAverage; }
                case OPCHDA_AGGREGATE.OPCHDA_COUNT:
                { return Opc.Ua.ObjectIds.AggregateFunction_Count; }
                case OPCHDA_AGGREGATE.OPCHDA_MINIMUMACTUALTIME:
                { return Opc.Ua.ObjectIds.AggregateFunction_MinimumActualTime; }
                case OPCHDA_AGGREGATE.OPCHDA_MINIMUM:
                { return Opc.Ua.ObjectIds.AggregateFunction_Minimum; }
                case OPCHDA_AGGREGATE.OPCHDA_MAXIMUMACTUALTIME:
                { return Opc.Ua.ObjectIds.AggregateFunction_MaximumActualTime; }
                case OPCHDA_AGGREGATE.OPCHDA_MAXIMUM:
                { return Opc.Ua.ObjectIds.AggregateFunction_Maximum; }
                case OPCHDA_AGGREGATE.OPCHDA_START:
                { return Opc.Ua.ObjectIds.AggregateFunction_Start; }
                case OPCHDA_AGGREGATE.OPCHDA_END:
                { return Opc.Ua.ObjectIds.AggregateFunction_End; }
                case OPCHDA_AGGREGATE.OPCHDA_DELTA:
                { return Opc.Ua.ObjectIds.AggregateFunction_Delta; }
                case OPCHDA_AGGREGATE.OPCHDA_RANGE:
                { return Opc.Ua.ObjectIds.AggregateFunction_Range; }
                case OPCHDA_AGGREGATE.OPCHDA_DURATIONGOOD:
                { return Opc.Ua.ObjectIds.AggregateFunction_DurationGood; }
                case OPCHDA_AGGREGATE.OPCHDA_DURATIONBAD:
                { return Opc.Ua.ObjectIds.AggregateFunction_DurationBad; }
                case OPCHDA_AGGREGATE.OPCHDA_PERCENTGOOD:
                { return Opc.Ua.ObjectIds.AggregateFunction_PercentGood; }
                case OPCHDA_AGGREGATE.OPCHDA_PERCENTBAD:
                { return Opc.Ua.ObjectIds.AggregateFunction_PercentBad; }
                case OPCHDA_AGGREGATE.OPCHDA_WORSTQUALITY:
                { return Opc.Ua.ObjectIds.AggregateFunction_WorstQuality; }
                case OPCHDA_AGGREGATE.OPCHDA_ANNOTATIONS:
                { return Opc.Ua.ObjectIds.AggregateFunction_AnnotationCount; }
            }
        ...
        public static uint GetHdaAggregateId(NodeId nodeId)
        {
            ...
            if (nodeId.NamespaceIndex == 0)
            {
                ...
                {
                    case Opc.Ua.Objects.AggregateFunction_Interpolative:
                    { return (uint)OPCHDA_AGGREGATE.OPCHDA_INTERPOLATIVE; }
                    case Opc.Ua.Objects.AggregateFunction_Total:
                    { return (uint)OPCHDA_AGGREGATE.OPCHDA_TOTAL; }
                    case Opc.Ua.Objects.AggregateFunction_Average:
                    { return (uint)OPCHDA_AGGREGATE.OPCHDA_AVERAGE; }
                    case Opc.Ua.Objects.AggregateFunction_TimeAverage:
                    { return (uint)OPCHDA_AGGREGATE.OPCHDA_TIMEAVERAGE; }
                    case Opc.Ua.Objects.AggregateFunction_Count:
                    { return (uint)OPCHDA_AGGREGATE.OPCHDA_COUNT; }
                    case Opc.Ua.Objects.AggregateFunction_MinimumActualTime:
                    { return (uint)OPCHDA_AGGREGATE.OPCHDA_MINIMUMACTUALTIME; }
                    case Opc.Ua.Objects.AggregateFunction_Minimum:
                    { return (uint)OPCHDA_AGGREGATE.OPCHDA_MINIMUMACTUALTIME; }
                    case Opc.Ua.Objects.AggregateFunction_MaximumActualTime:
                    { return (uint)OPCHDA_AGGREGATE.OPCHDA_MAXIMUMACTUALTIME; }
                    case Opc.Ua.Objects.AggregateFunction_Maximum:
                    { return (uint)OPCHDA_AGGREGATE.OPCHDA_MAXIMUM; }
                    case Opc.Ua.Objects.AggregateFunction_Start:
                    { return (uint)OPCHDA_AGGREGATE.OPCHDA_START; }
                    case Opc.Ua.Objects.AggregateFunction_End:
                    { return (uint)OPCHDA_AGGREGATE.OPCHDA_END; }
                    case Opc.Ua.Objects.AggregateFunction_Delta:
                    { return (uint)OPCHDA_AGGREGATE.OPCHDA_DELTA; }
                    case Opc.Ua.Objects.AggregateFunction_Range:
                    { return (uint)OPCHDA_AGGREGATE.OPCHDA_RANGE; }
                    case Opc.Ua.Objects.AggregateFunction_DurationGood:
                    { return (uint)OPCHDA_AGGREGATE.OPCHDA_DURATIONGOOD; }
                    case Opc.Ua.Objects.AggregateFunction_DurationBad:
                    { return (uint)OPCHDA_AGGREGATE.OPCHDA_DURATIONBAD; }
                    case Opc.Ua.Objects.AggregateFunction_PercentGood:
                    { return (uint)OPCHDA_AGGREGATE.OPCHDA_PERCENTGOOD; }
                    case Opc.Ua.Objects.AggregateFunction_PercentBad:
                    { return (uint)OPCHDA_AGGREGATE.OPCHDA_PERCENTBAD; }
                    case Opc.Ua.Objects.AggregateFunction_WorstQuality:
                    { return (uint)OPCHDA_AGGREGATE.OPCHDA_WORSTQUALITY; }
                    case Opc.Ua.Objects.AggregateFunction_AnnotationCount:
                    { return (uint)OPCHDA_AGGREGATE.OPCHDA_ANNOTATIONS; }
                }
            }
        ...
        public static int GetAccessRights(byte accessLevel)
        {
            ...
            {
                accessRights |= Technosoftware.Rcw.Constants.OPC_READABLE;
            }

            if ((accessLevel & AccessLevels.CurrentWrite) != 0)
            {
                accessRights |= Technosoftware.Rcw.Constants.OPC_WRITEABLE;
            }
        ...
        public static System.Runtime.InteropServices.ComTypes.FILETIME[] GetFILETIMEs(ref IntPtr pArray, int size)
        {
            ...
            for (int ii = 0; ii < size; ii++)
            {
                try
                {
                    values[ii] = (System.Runtime.InteropServices.ComTypes.FILETIME)Marshal.PtrToStructure(
                        pos,
        ...
        public static DateTime GetDateTime(IntPtr pFiletime)
        {
            ...
            return GetDateTime(
                (System.Runtime.InteropServices.ComTypes.FILETIME)Marshal.PtrToStructure(pFiletime, typeof(System.Runtime.InteropServices.ComTypes.FILETIME)));
        }
        ...
        public static object GetVARIANT(object source, ITelemetryContext telemetry)
        {
            ...
            return GetVARIANT(source, Opc.Ua.TypeInfo.Construct(source), telemetry);
        }
        ...
        /// <param name="telemetry"></param>
        /// <returns>The converted object.</returns>
        public static object GetVARIANT(Variant source, ITelemetryContext telemetry)
        {
            return GetVARIANT(source.Value, source.TypeInfo, telemetry);
        }
        ...
        /// <param name="telemetry"></param>
        /// <returns>The converted object.</returns>
        public static object GetVARIANT(object source, Opc.Ua.TypeInfo typeInfo, ITelemetryContext telemetry)
        {
            // check for invalid args.
            if (source == null)
            {
            ...
            try
            {
                switch (typeInfo.BuiltInType)
                {
                    ...
                    case BuiltInType.ByteString:
                    {
                        ...
                        return VariantToObjectArray((Array)source, telemetry);
                    }
                    ...
                    {
                        return Opc.Ua.TypeInfo.Cast(source, typeInfo, BuiltInType.String);
                    }

                    case BuiltInType.StatusCode:
                    {
                        return Opc.Ua.TypeInfo.Cast(source, typeInfo, BuiltInType.UInt32);
                    }
                    ...
                    case BuiltInType.Variant:
                    {
                        if (typeInfo.ValueRank < 0)
                        {
                            return GetVARIANT(((Variant)source).Value, telemetry);
                        }
                    ...
                    case BuiltInType.ExtensionObject:
                    {
                        if (typeInfo.ValueRank < 0)
                        {
                            ...
                            switch (extension.Encoding)
                            {
                                ...
                                {
                                    BinaryEncoder encoder = new BinaryEncoder(new ServiceMessageContext(telemetry));
        ...
        /// </summary>
        private static Array VariantToObjectArray(Array input, ITelemetryContext telemetry)
        {
            ...
            for (int ii = 0; ii < length; ii++)
            {
                ...
                output.SetValue(GetVARIANT(value, telemetry), indexes);
            }
        ...
        public static IntPtr GetVARIANTs(object[] values, bool preprocess, ITelemetryContext telemetry)
        {
            ...
            for (int ii = 0; ii < count; ii++)
            {
                if (preprocess)
                {
                    Marshal.GetNativeVariantForObject(GetVARIANT(values[ii], telemetry), pos);
                }
                else
                {
        ...
        /// </summary>
        public static VarEnum GetVarType(Opc.Ua.TypeInfo typeInfo)
        {
            if (typeInfo == null)
            {
                return VarEnum.VT_EMPTY;
            ...
            {
                case BuiltInType.Boolean:
                { vtType = VarEnum.VT_BOOL; break; }
                case BuiltInType.SByte:
                { vtType = VarEnum.VT_I1; break; }
                case BuiltInType.Byte:
                { vtType = VarEnum.VT_UI1; break; }
                case BuiltInType.Int16:
                { vtType = VarEnum.VT_I2; break; }
                case BuiltInType.UInt16:
                { vtType = VarEnum.VT_UI2; break; }
                case BuiltInType.Int32:
                { vtType = VarEnum.VT_I4; break; }
                case BuiltInType.UInt32:
                { vtType = VarEnum.VT_UI4; break; }
                case BuiltInType.Int64:
                { vtType = VarEnum.VT_I8; break; }
                case BuiltInType.UInt64:
                { vtType = VarEnum.VT_UI8; break; }
                case BuiltInType.Float:
                { vtType = VarEnum.VT_R4; break; }
                case BuiltInType.Double:
                { vtType = VarEnum.VT_R8; break; }
                case BuiltInType.String:
                { vtType = VarEnum.VT_BSTR; break; }
                case BuiltInType.DateTime:
                { vtType = VarEnum.VT_DATE; break; }
                case BuiltInType.Guid:
                { vtType = VarEnum.VT_BSTR; break; }
                case BuiltInType.ByteString:
                { vtType = VarEnum.VT_ARRAY | VarEnum.VT_UI1; break; }
                case BuiltInType.XmlElement:
                { vtType = VarEnum.VT_BSTR; break; }
                case BuiltInType.NodeId:
                { vtType = VarEnum.VT_BSTR; break; }
                ...
                try
                {
                    ...
                    switch (targetType)
                    {
                        ...
                        case VarEnum.VT_UI8:
                        {
                            ...
                            try
                            { sourceAsDecimal = System.Convert.ToDecimal(source); }
        ...
        public static StatusCode GetQualityCode(short quality)
        {
            ...
            {
                case Technosoftware.Rcw.Qualities.OPC_QUALITY_GOOD:
                { code = StatusCodes.Good; break; }
                case Technosoftware.Rcw.Qualities.OPC_QUALITY_LOCAL_OVERRIDE:
                { code = StatusCodes.GoodLocalOverride; break; }
                case Technosoftware.Rcw.Qualities.OPC_QUALITY_UNCERTAIN:
                { code = StatusCodes.Uncertain; break; }
                case Technosoftware.Rcw.Qualities.OPC_QUALITY_SUB_NORMAL:
                { code = StatusCodes.UncertainSubNormal; break; }
                case Technosoftware.Rcw.Qualities.OPC_QUALITY_SENSOR_CAL:
                { code = StatusCodes.UncertainSensorNotAccurate; break; }
                case Technosoftware.Rcw.Qualities.OPC_QUALITY_EGU_EXCEEDED:
                { code = StatusCodes.UncertainEngineeringUnitsExceeded; break; }
                case Technosoftware.Rcw.Qualities.OPC_QUALITY_LAST_USABLE:
                { code = StatusCodes.UncertainLastUsableValue; break; }
                case Technosoftware.Rcw.Qualities.OPC_QUALITY_BAD:
                { code = StatusCodes.Bad; break; }
                case Technosoftware.Rcw.Qualities.OPC_QUALITY_CONFIG_ERROR:
                { code = StatusCodes.BadConfigurationError; break; }
                case Technosoftware.Rcw.Qualities.OPC_QUALITY_NOT_CONNECTED:
                { code = StatusCodes.BadNotConnected; break; }
                case Technosoftware.Rcw.Qualities.OPC_QUALITY_COMM_FAILURE:
                { code = StatusCodes.BadNoCommunication; break; }
                case Technosoftware.Rcw.Qualities.OPC_QUALITY_DEVICE_FAILURE:
                { code = StatusCodes.BadDeviceFailure; break; }
                case Technosoftware.Rcw.Qualities.OPC_QUALITY_SENSOR_FAILURE:
                { code = StatusCodes.BadSensorFailure; break; }
                case Technosoftware.Rcw.Qualities.OPC_QUALITY_LAST_KNOWN:
                { code = StatusCodes.BadOutOfService; break; }
                case Technosoftware.Rcw.Qualities.OPC_QUALITY_OUT_OF_SERVICE:
                { code = StatusCodes.BadOutOfService; break; }
                case Technosoftware.Rcw.Qualities.OPC_QUALITY_WAITING_FOR_INITIAL_DATA:
                { code = StatusCodes.BadWaitingForInitialData; break; }
            }

            // convert the limit status.
            switch ((short)(quality & 0x0003))
            {
                case Technosoftware.Rcw.Qualities.OPC_LIMIT_LOW:
                { code.LimitBits = LimitBits.Low; break; }
                case Technosoftware.Rcw.Qualities.OPC_LIMIT_HIGH:
                { code.LimitBits = LimitBits.High; break; }
                case Technosoftware.Rcw.Qualities.OPC_LIMIT_CONST:
                { code.LimitBits = LimitBits.Constant; break; }
            }
        ...
        public static short GetQualityCode(StatusCode input)
        {
            ...
            switch (input.CodeBits)
            {
                ...
                { code = Technosoftware.Rcw.Qualities.OPC_QUALITY_GOOD; break; }
                case StatusCodes.GoodLocalOverride:
                { code = Technosoftware.Rcw.Qualities.OPC_QUALITY_LOCAL_OVERRIDE; break; }
                case StatusCodes.Uncertain:
                { code = Technosoftware.Rcw.Qualities.OPC_QUALITY_UNCERTAIN; break; }
                case StatusCodes.UncertainSubNormal:
                { code = Technosoftware.Rcw.Qualities.OPC_QUALITY_SUB_NORMAL; break; }
                case StatusCodes.UncertainSensorNotAccurate:
                { code = Technosoftware.Rcw.Qualities.OPC_QUALITY_SENSOR_CAL; break; }
                case StatusCodes.UncertainEngineeringUnitsExceeded:
                { code = Technosoftware.Rcw.Qualities.OPC_QUALITY_EGU_EXCEEDED; break; }
                case StatusCodes.UncertainLastUsableValue:
                { code = Technosoftware.Rcw.Qualities.OPC_QUALITY_LAST_USABLE; break; }
                case StatusCodes.Bad:
                { code = Technosoftware.Rcw.Qualities.OPC_QUALITY_BAD; break; }
                case StatusCodes.BadConfigurationError:
                { code = Technosoftware.Rcw.Qualities.OPC_QUALITY_CONFIG_ERROR; break; }
                case StatusCodes.BadNotConnected:
                { code = Technosoftware.Rcw.Qualities.OPC_QUALITY_NOT_CONNECTED; break; }
                case StatusCodes.BadNoCommunication:
                { code = Technosoftware.Rcw.Qualities.OPC_QUALITY_COMM_FAILURE; break; }
                case StatusCodes.BadOutOfService:
                { code = Technosoftware.Rcw.Qualities.OPC_QUALITY_OUT_OF_SERVICE; break; }
                case StatusCodes.BadDeviceFailure:
                { code = Technosoftware.Rcw.Qualities.OPC_QUALITY_DEVICE_FAILURE; break; }
                case StatusCodes.BadSensorFailure:
                { code = Technosoftware.Rcw.Qualities.OPC_QUALITY_SENSOR_FAILURE; break; }
                case StatusCodes.BadWaitingForInitialData:
                { code = Technosoftware.Rcw.Qualities.OPC_QUALITY_WAITING_FOR_INITIAL_DATA; break; }

                default:
                {
                    if (StatusCode.IsBad(input))
                    {
                        code = Technosoftware.Rcw.Qualities.OPC_QUALITY_BAD;
                        break;
                    }

                    if (StatusCode.IsUncertain(input))
                    {
                        code = Technosoftware.Rcw.Qualities.OPC_QUALITY_UNCERTAIN;
                        break;
                    }

                    code = Technosoftware.Rcw.Qualities.OPC_QUALITY_GOOD;
                    break;
                }
            }
            ...
            {
                case LimitBits.Low:
                { code |= Technosoftware.Rcw.Qualities.OPC_LIMIT_LOW; break; }
                case LimitBits.High:
                { code |= Technosoftware.Rcw.Qualities.OPC_LIMIT_HIGH; break; }
                case LimitBits.Constant:
                { code |= Technosoftware.Rcw.Qualities.OPC_LIMIT_CONST; break; }
            }
        ...
        public static StatusCode GetHdaQualityCode(uint quality)
        {
            ...
            if ((hdaCode & Technosoftware.Rcw.Constants.OPCHDA_NOBOUND) != 0)
            {
                return StatusCodes.BadBoundNotFound;
            }

            if ((hdaCode & Technosoftware.Rcw.Constants.OPCHDA_NODATA) != 0)
            {
                return StatusCodes.BadNoData;
            }

            if ((hdaCode & Technosoftware.Rcw.Constants.OPCHDA_DATALOST) != 0)
            {
                return StatusCodes.BadDataLost;
            }

            if ((hdaCode & Technosoftware.Rcw.Constants.OPCHDA_CONVERSION) != 0)
            {
            ...
            if ((hdaCode & Technosoftware.Rcw.Constants.OPCHDA_EXTRADATA) != 0)
            {
                aggregateBits |= AggregateBits.ExtraData;
            }

            if ((hdaCode & Technosoftware.Rcw.Constants.OPCHDA_INTERPOLATED) != 0)
            {
                aggregateBits |= AggregateBits.Interpolated;
            }

            if ((hdaCode & Technosoftware.Rcw.Constants.OPCHDA_RAW) != 0)
            {
                aggregateBits |= AggregateBits.Raw;
            }

            if ((hdaCode & Technosoftware.Rcw.Constants.OPCHDA_CALCULATED) != 0)
            {
                aggregateBits |= AggregateBits.Calculated;
            }

            if ((hdaCode & Technosoftware.Rcw.Constants.OPCHDA_PARTIAL) != 0)
            {
        ...
        public static uint GetHdaQualityCode(StatusCode input)
        {
            ...
            switch (input.CodeBits)
            {
                ...
                { return Technosoftware.Rcw.Constants.OPCHDA_NOBOUND; }
                case StatusCodes.BadBoundNotSupported:
                { return Technosoftware.Rcw.Constants.OPCHDA_NOBOUND; }
                case StatusCodes.BadNoData:
                { return Technosoftware.Rcw.Constants.OPCHDA_NODATA; }
                case StatusCodes.BadDataLost:
                { return Technosoftware.Rcw.Constants.OPCHDA_DATALOST; }
            }
            ...
            {
                code |= Technosoftware.Rcw.Constants.OPCHDA_EXTRADATA;
            }

            // set the source of the data.
            if ((aggregateBits & AggregateBits.Interpolated) != 0)
            {
                code |= Technosoftware.Rcw.Constants.OPCHDA_INTERPOLATED;
            }
            else if ((aggregateBits & AggregateBits.Calculated) != 0)
            {
                code |= Technosoftware.Rcw.Constants.OPCHDA_CALCULATED;
            }
            else if ((aggregateBits & AggregateBits.Partial) != 0)
            {
                code |= Technosoftware.Rcw.Constants.OPCHDA_PARTIAL;
            }
            else
            {
                code |= Technosoftware.Rcw.Constants.OPCHDA_RAW;
            }
