...
namespace Technosoftware.ClientGateway.Hda
{
    ...
    /// </summary>
    /// <exclude />
    internal class HdaReadRequest
    {
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="Technosoftware.ClientGateway.Da.ReadRequest"/> class.
        /// </summary>
    ...
    /// </summary>
    internal class HdaReadRequestCollection : List<HdaReadRequest>
    {
        #region Public Methods
        /// <summary>
        ...
        private StatusCode Add(HdaAttributeState attribute, ReadValueId nodeToRead, out bool queued)
        {
            ...
            if (nodeToRead.AttributeId != Attributes.Value && nodeToRead.AttributeId != Attributes.AccessLevel &&
