...
namespace Technosoftware.ClientGateway.Hda
{
    ...
    /// </summary>
    internal class HdaElementBrower : NodeBrowser
    {
        #region Constructors
        /// <summary>
        ...
        /// <param name="sourceTypeDefinitionId">The type definition id.</param>
        /// <param name="sourceBrowseName"></param>
        ...
        private void NextStage()
        {
            ...
            if (m_stage == Stage.Browse)
            {
                ...
                {
                    m_browser = new ComHdaBrowserClient(client, m_itemId, SystemContext.Telemetry);
                }
