...
namespace Technosoftware.ClientGateway.Hda
{
    ...
    /// </summary>
    /// <exclude />
    internal class HdaHistoryBaseRequest
    {
        /// <summary>
            ...
            params HdaAttributeValue[] sources)
        {
            ...
            switch (attributeId)
            {
                ...
                case Constants.OPCHDA_MIN_TIME_INT:
                {
                    ...
                    try
                    {
                        value.Value = System.Convert.ToDouble(number);
                    }
                    catch (Exception)
                    {
    ...
    /// </summary>
    /// <exclude />
    internal class HdaHistoryReadRequest : HdaHistoryBaseRequest
    {
        #region Constructors
        /// <summary>
    ...
    /// </summary>
    /// <exclude />
    internal class HdaHistoryReadRawModifiedRequest : HdaHistoryReadRequest
    {
        #region Constructors
        /// <summary>
    ...
    /// </summary>
    /// <exclude />
    internal class HdaHistoryReadAtTimeRequest : HdaHistoryReadRequest
    {
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="HdaHistoryReadRawModifiedRequest"/> class.
    ...
    /// </summary>
    /// <exclude />
    internal class HdaHistoryReadAttributeRequest : HdaHistoryReadRawModifiedRequest
    {
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="HdaHistoryReadRawModifiedRequest"/> class.
    ...
    /// </summary>
    /// <exclude />
    internal class HdaHistoryReadAnnotationRequest : HdaHistoryReadRawModifiedRequest
    {
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="HdaHistoryReadRawModifiedRequest"/> class.
    ...
    /// </summary>
    /// <exclude />
    internal class HdaHistoryReadProcessedRequest : HdaHistoryReadRequest
    {
        #region Constructors
        /// <summary>
