...
namespace Technosoftware.UaServer
{
    ...
    /// </summary>
    public interface IUaMasterNodeManager
    {
        /// <summary>
        /// The node managers being managed.
        /// </summary>
        IReadOnlyList<IUaStandardAsyncNodeManager> AsyncNodeManagers { get; }
        ...
        /// The node managers being managed.
        /// </summary>
        IReadOnlyList<IUaNodeManager> NodeManagers { get; }
        ...
        object GetManagerHandle(NodeId nodeId, out IUaStandardAsyncNodeManager nodeManager);

        /// <summary>
        /// Returns node handle and its node manager.
        /// </summary>
        object GetManagerHandle(NodeId nodeId, out IUaNodeManager nodeManager);

        /// <summary>
        /// Returns node handle and its node manager.
        /// </summary>
        ValueTask<(object handle, IUaStandardAsyncNodeManager nodeManager)> GetManagerHandleAsync(NodeId nodeId, CancellationToken cancellationToken = default);
        ...
        void RegisterNamespaceManager(string namespaceUri, IUaStandardAsyncNodeManager nodeManager);
        ...
        /// </remarks>
        /// <exception cref="ArgumentNullException">Throw if the namespaceUri or the nodeManager are null.</exception>
        void RegisterNamespaceManager(string namespaceUri, IUaNodeManager nodeManager);

        /// <summary>
        /// Registers a set of node ids.
        /// </summary>
        /// <exception cref="ArgumentNullException"><paramref name="nodesToRegister"/> is <c>null</c>.</exception>
        void RegisterNodes(UaServerOperationContext context, NodeIdCollection nodesToRegister, out NodeIdCollection registeredNodeIds);
        ...
        /// <exception cref="ArgumentNullException">Throw if the namespaceUri or the nodeManager are null.</exception>
        bool UnregisterNamespaceManager(string namespaceUri, IUaStandardAsyncNodeManager nodeManager);
        ...
        /// <returns>A value indicating whether the node manager was successfully unregistered.</returns>
        /// <exception cref="ArgumentNullException">Throw if the namespaceUri or the nodeManager are null.</exception>
        bool UnregisterNamespaceManager(string namespaceUri, IUaNodeManager nodeManager);

        /// <summary>
        /// Unregisters a set of node ids.
        /// </summary>
        /// <exception cref="ArgumentNullException"><paramref name="nodesToUnregister"/> is <c>null</c>.</exception>
        void UnregisterNodes(UaServerOperationContext context, NodeIdCollection nodesToUnregister);
