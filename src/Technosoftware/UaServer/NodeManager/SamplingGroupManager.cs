...
namespace Technosoftware.UaServer.NodeManager
{
    ...
    public class SamplingGroupManager : IDisposable
    {
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (disposing)
            {
                ...
                lock (m_lock)
                {
                    ...
                    monitoredItems = new List<IUaSampledDataChangeMonitoredItem>(m_sampledItems.Keys);
        ...
        /// </summary>
        public virtual UaMonitoredItem RestoreMonitoredItem(
            object managerHandle,
            IUaStoredMonitoredItem storedMonitoredItem,
            IUserIdentity savedOwnerIdentity)
        {
            // create monitored item.
            UaMonitoredItem monitoredItem = new UaMonitoredItem(m_server, m_nodeManager, managerHandle, storedMonitoredItem);

            // start sampling.
            StartMonitoring(new UaServerOperationContext(monitoredItem), monitoredItem, savedOwnerIdentity);
        ...
        /// </remarks>
        public virtual void StartMonitoring(UaServerOperationContext context, IUaSampledDataChangeMonitoredItem monitoredItem, IUserIdentity savedOwnerIdentity = null)
        {
            lock (m_lock)
            {
        ...
        private Dictionary<IUaSampledDataChangeMonitoredItem, SamplingGroup> m_sampledItems;
