...
namespace Technosoftware.UaServer
{
    ...
    public interface IUaSubscriptionManager : IDisposable
    {
        ...
        /// </summary>
        ValueTask<StatusCode> DeleteSubscriptionAsync(UaServerOperationContext context, uint subscriptionId, CancellationToken cancellationToken = default);
    ...
    public delegate void SubscriptionEventHandler(IUaSubscription subscription, bool deleted);
}
