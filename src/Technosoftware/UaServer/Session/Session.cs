...
namespace Technosoftware.UaServer.Sessions
{
    ...
    public class Session : IDisposable
    {
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (disposing)
            {
                List<UaContinuationPoint> browseCPs = null;
        ...
        public UaContinuationPoint RestoreContinuationPoint(byte[] continuationPoint)
        {
            lock (m_lock)
            {
                ...
                for (int ii = 0; ii < m_browseContinuationPoints.Count; ii++)
                {
                    ...
                    {
                        UaContinuationPoint cp = m_browseContinuationPoints[ii];
        ...
        {
            UaServerUtils.EventLog.SessionState(context, m_sessionId.ToString(), m_sessionName,
