...
{
    /// <summary>
    /// Second part of the see<see cref="UaStandardNodeManager"/> class."/>
    /// Implementation of the <see cref="IUaStandardAsyncNodeManager"/> interface for custom node management.
