...
namespace Technosoftware.UaServer
{
    ...
    /// </remarks>
    public partial class UaStandardNodeManager : IUaStandardNodeManager, INodeIdFactory, IDisposable
    {
        #region Constructors, Destructor, Initialization
        /// <summary>
        /// Initializes the node manager.
        /// </summary>
        /// <param name="server">The uaServerData data implementing the IUaServerData interface.</param>
            ...
            params string[] namespaceUris)
        {
            ...
            if (namespaceUris != null)
            {
                ...
                {
                    namespaceIndexes[ii] = ServerData.NamespaceUris.GetIndexOrAppend(namespaceUris[ii]);
                }
            }
        ...
        /// </summary>
        protected NodeIdDictionary<UaMonitoredNode> MonitoredNodes
            => m_monitoredItemManager.MonitoredNodes;

        /// <summary>
        /// Gets the table of monitored items managed by the node manager.
        /// </summary>
        protected ConcurrentDictionary<uint, IUaMonitoredItem> MonitoredItems
        ...
        protected void SetNamespaceIndexes(ushort[] namespaceIndexes)
        {
            ...
            {
                namespaceUris[ii] = ServerData.NamespaceUris.GetString(namespaceIndexes[ii]);
            }
        ...
        {
            if (managerHandle is not UaNodeHandle source)
            {
                return null;
            }
        ...
        /// </summary>
        public bool DeleteNode(UaServerContext context, NodeId nodeId)
        {
            UaServerContext contextToUse = SystemContext.Copy(context);
        ...
        public NodeState FindNodeInAddressSpace(NodeId nodeId)
        {
            ...
            {
                if (nodeManager.GetManagerHandle(nodeId) is not UaNodeHandle handle)
                {
                    continue;
                }
                return handle.Node;
        ...
        /// It is thread safe to call this method outside the node manager lock.
        /// </remarks>
        protected virtual UaNodeHandle GetManagerHandle(
            UaServerContext context,
            NodeId nodeId,
            ...
            UaContinuationPoint continuationPoint)
        {
            ...
            if (target == null)
            {
                UaNodeHandle handle = GetManagerHandle(context, (NodeId)reference.TargetId, null);
                ...
                try
                {
                        ...
                        reference = browser.Next())
                    {
                        ...
                        if (target == null)
                        {
                            ...
                            UaNodeHandle targetHandle = GetManagerHandle(
                                systemContext,
                                targetId,
                                operationCache);
            ...
            IList<ServiceResult> errors)
        {
            ...
            lock (Lock)
            {
                for (int ii = 0; ii < nodesToRead.Count; ii++)
                {
                    ...
                    // check for valid handle.
                    UaNodeHandle handle = GetManagerHandle(
                        systemContext,
                        nodeToRead.NodeId,
                        operationCache);
                    ...
                    {
                        UaServerUtils.EventLog.ReadValueRange(
                            nodeToRead.NodeId,
                            value.WrappedValue,
...
#if DEBUG
                    UaServerUtils.EventLog.WriteValueRange(
                        nodeToWrite.NodeId,
            ...
            object previousPropertyValue)
        {
            ...
            foreach (KeyValuePair<uint, IUaMonitoredItem> kvp in MonitoredItems)
            {
                if (kvp.Value is not IUaSampledDataChangeMonitoredItem monitoredItem ||
                ...
                if (monitoredItem.ManagerHandle is not UaNodeHandle handle || handle.Node == null)
                {
                    continue;
                }
            ...
            IDictionary<NodeId, NodeState> cache)
        {
            ...
            if (details is ReadEventDetails readEventDetails)
            {
                ...
                EventFilter.Result result = readEventDetails.Filter.Validate(
                    new FilterContext(ServerData.NamespaceUris, ServerData.TypeTree, context));
            ...
            bool unsubscribe)
        {
            ...
            lock (Lock)
            {
                // A client has subscribed to the ServerData object which means all events produced
        ...
        protected virtual void AddRootNotifier(NodeState notifier)
        {
            lock (Lock)
            {
                ...
                {
                    IList<IUaEventMonitoredItem> monitoredItems = ServerData.EventManager
                        .GetMonitoredItems();
        ...
        protected virtual ServiceResult SubscribeToEvents(
            ...
            bool unsubscribe)
        {
            (UaMonitoredNode monitoredNode, ServiceResult serviceResult) = m_monitoredItemManager
                .SubscribeToEvents(
                    context,
                    source,
                    monitoredItem,
            ...
            for (int ii = 0; ii < monitoredItems.Count; ii++)
            {
                ...
                lock (Lock)
                {
                    ...
                    else
                    {
                        ...
                        nodesToRefresh.Add(((UaNodeHandle)monitoredItem.ManagerHandle).Node);
                    }
                }
            ...
            IUserIdentity savedOwnerIdentity)
        {
            ...
            UaServerContext systemContext = SystemContext.Copy();
            IDictionary<NodeId, NodeState> operationCache = new NodeIdDictionary<NodeState>();
            var nodesToValidate = new List<UaNodeHandle>();
            ...
            out IUaMonitoredItem monitoredItem)
        {
            ...
            bool success = m_monitoredItemManager.RestoreMonitoredItem(
                ...
                out IUaSampledDataChangeMonitoredItem restoredItem);
            ...
            out IUaMonitoredItem monitoredItem)
        {
            ...
            IUaSampledDataChangeMonitoredItem dataChangeMonitoredItem = m_monitoredItemManager
                .CreateMonitoredItem(
                    ServerData,
                    this,
                    context,
            ...
            PermissionType requestedPermission)
        {
            ...
            object nodeHandle = ServerData.NodeManager
                .GetManagerHandle(nodeId, out IUaNodeManager nodeManager);
            ...
            IList<MonitoringFilterResult> filterErrors)
        {
            ...
            lock (Lock)
            {
                foreach ((int, UaNodeHandle) nodeInNamespace in nodesInNamespace)
                {
                    int ii = nodeInNamespace.Item1;
                    UaNodeHandle handle = nodeInNamespace.Item2;
                    MonitoredItemModifyRequest itemToModify = itemsToModify[ii];
            ...
            out MonitoringFilterResult filterResult)
        {
            ...
            var datachangeItem = monitoredItem as IUaSampledDataChangeMonitoredItem;
        ...
        protected virtual ServiceResult DeleteMonitoredItem(
            ...
            UaNodeHandle handle)
        {
            var sampledDataChangeMonitoredItem = monitoredItem as IUaSampledDataChangeMonitoredItem;
        ...
        {
            UaServerContext systemContext = SystemContext.Copy(context);
            var transferredItems = new List<IUaMonitoredItem>();
            lock (Lock)
            {
                for (int ii = 0; ii < monitoredItems.Count; ii++)
                {
        ...
        {
            if (nodeHandle is not UaNodeHandle handle)
            {
                return false;
            }
            ...
            UaNodeMetadata metadata)
        {
            ...
            NamespaceMetadataState namespaceMetadataState =
                ServerData.NodeManager.ConfigurationNodeManager.GetNamespaceMetadataState(namespaceUri);
        ...
        #endregion Method related functions
        ...
        #endregion Random value generator
        ...
        /// </summary>
        protected IUaMonitoredItemManager m_monitoredItemManager;
