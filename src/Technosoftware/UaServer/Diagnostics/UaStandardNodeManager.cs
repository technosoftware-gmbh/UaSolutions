    ...
    public partial class UaStandardNodeManager : IUaStandardNodeManager, INodeIdFactory, IDisposable
    {
        ...
        protected UaStandardNodeManager(
            ...
            : this(
                  ...
                  configuration,
                  useSamplingGroups,
                  server.Telemetry.CreateLogger<UaStandardNodeManager>(),
                  namespaceUris)
        {
        }
            ...
            IDictionary<NodeId, NodeState> cache)
        {
            ...
            if (details is ReadEventDetails readEventDetails)
            {
                ...
                EventFilter.Result result = readEventDetails.Filter.Validate(
                    new FilterContext(ServerData.NamespaceUris, ServerData.TypeTree, context, ServerData.Telemetry));
...
#pragma warning restore CA2012 // Use ValueTasks correctly
            ...
            out IUaMonitoredItem monitoredItem)
        {
            ...
            IUaSampledDataChangeMonitoredItem dataChangeMonitoredItem =
        ...
        protected void ResetRandomGenerator(int seed, int boundaryValueFrequency = 0)
        {
            ...
            m_generator = new DataGenerator(m_randomSource, ServerData.Telemetry)
            {
        ...
        protected object GetNewValue(BaseVariableState variable)
        {
            ...
            {
                value = m_generator.GetRandom(variable.DataType, variable.ValueRank, new uint[] { 10 }, ServerData.TypeTree);
                // skip Variant Null
