...
namespace SampleCompany.NodeManagers.MemoryBuffer
{
    ...
    public class MemoryBufferBrowser : NodeBrowser
    {
        ...
        {
            // NodeBrowser has no DataLock in 2.0: browsers are single-consumer
            // and both server browse paths already serialize on the owning side,
            // so the lock only imposed a contract no derived type could reason about.
